...
export const TipoDocumentoRow: React.FC<Props> = ({ tipoDocumento }) => {
  ...
  const handleConfirmStatus = async () => {
    ...
    try {
      ...
      //     if (onStatusChange) {
      //       onStatusChange(tipoDocumento.id);
      //     }
      //   } else {
      //     showToast("error", error || "Error al actualizar el tipoDocumento.");
      //   }
  ...
  return (
    <>
      ...
      >
        <TableCell className="py-3">{tipoDocumento.nombre}</TableCell>
        <TableCell className="py-3">{tipoDocumento.descripcion}</TableCell>
        <TableCell className="py-3">{tipoDocumento.abreviatura}</TableCell>
          ...
          <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
            ...
            >
              ...
              >
                ...
                <span>{actionText} Tipo documento</span>
              </DropdownMenuItem>
