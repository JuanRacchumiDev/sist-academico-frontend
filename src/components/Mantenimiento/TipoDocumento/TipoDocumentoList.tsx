...
export const TipoDocumentoList = () => {
  const newRoute = `/mantenimiento/tipo-documento/nuevo`;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div className="space-y-0.5">
          ...
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">
            Listado de{" "}
            <span className="text-indigo-600">tipo de documentos</span>
          </h1>
          <p className="text-xs text-slate-500">
            Administra, visualiza y gestiona la información de todos los tipo de
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Plus className="w-4 h-4" /> Nuevo tipo de documento
          </Link>
        </div>
      </div>
