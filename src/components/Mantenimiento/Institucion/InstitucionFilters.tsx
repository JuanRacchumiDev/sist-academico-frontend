...
export interface InstitucionFilterProps {
  onSearch: (filters: InstitucionFiltersData) => void;
}

export interface InstitucionFiltersData {
  search: string;
}

export const InstitucionFilters: React.FC<InstitucionFilterProps> = ({
  onSearch,
}) => {
  const [filters, setFilters] = useState<InstitucionFiltersData>({
    search: "",
  });
